...
*/
static void hashDoInsert(HashInt *hash, int key, char *value){
...
static void hashDoUpdate(HashInt *hash, int key, char *value){
...
void hashInsert(HashInt *hash, int key, char *value){
